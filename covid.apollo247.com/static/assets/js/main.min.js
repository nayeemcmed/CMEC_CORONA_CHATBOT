...
const protocol=window.location.protocol;const hostname=window.location.host;const domain=protocol+"//"+hostname;const url=domain+"/"+"risk";function initBot(){inputObj={age:"",temperature:"",temperatureText:"",gender:"",genderText:"",symptoms:"",symptomsText:"",additionalSymptoms:"",additionalSymptomsText:"",exposureHistory:"",exposureHistoryText:"",underlyingConditions:"",underlyingConditionsText:"",progress:"",progressText:""};botui.message.bot({delay:500,loading:!0,content:"সিমেড হেলথ লিমিটেড এবং বাংলাদেশের স্বাস্থ্য মন্ত্রনালয় এর সহযোগিতায় নির্মিত এই স্ব-মূল্যায়ন পরিসেবাটি আপনাকে  করোনা ভাইরাস (কোভিড -১৯) এর প্রাথমিক উপসর্গ নির্ধারণ করতে সহায়তা করবে, যাতে করে আপনি বুঝতে পারেন এর জন্য আপনার আরও মূল্যায়ন বা পরীক্ষার প্রয়োজন আছে কি না । আপনি এই মূল্যায়নটি নিজের জন্য বা অন্য কারো পক্ষ হয়ে করতে পারেন।"}).then(()=>{return botui.message.bot({delay:200,content:"আপনার বয়স কত?"})}).then(()=>{return botui.action.text({cssClass:"form-control",action:{sub_type:"number",placeholder:"Your age in years",required:!0,min:"0",max:"100",button:{label:"Done"}}})}).then(res=>{inputObj.age=res.value;return botui.message.bot({delay:500,loading:!0,content:"আপনি কি পুরুষ/মহিলা"})}).then(()=>{return botui.action.button({delay:100,action:[{text:"Male",value:"1"},{text:"Female",value:"2"},{text:"Others",value:"0"}]})}).then(res=>{inputObj.gender=res.value;inputObj.genderText=res.text;return botui.message.bot({delay:500,loading:!0,content:"আপনার দেহের তাপমাত্রা এখন কত?"})}).then(()=>{return botui.action.button({delay:100,action:[{text:"Normal (96°F-98.6°F)",value:"0"},{text:"Fever (98.6°F-102°F)",value:"1"},{text:"High Fever (>102°F)",value:"2"},{text:"Don’t know",value:"0"}]})}).then(res=>{inputObj.temperature=res.value;inputObj.temperatureText=res.text;return botui.message.bot({delay:500,loading:!0,content:"নীচে উল্লেখিত সমস্যাগুলোর মধ্যে কন্তি কি আপনার আছে"})}).then(()=>{return botui.action.button({delay:100,cssClass:"multiselect",multiselect:!0,action:[{text:"Dry Cough",value:"0",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}},{text:"Sneezing",value:"2",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}},{text:"Sore Throat",value:"3",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}},{text:"Weakness",value:"4",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}}]})}).then(res=>{inputObj.symptoms=res.value.join("|");inputObj.symptomsText=res.text;if(inputObj.temperature==="1"){inputObj.symptoms=inputObj.temperature+(inputObj.symptoms!==""?"|":"")+inputObj.symptoms;inputObj.symptomsText=inputObj.temperatureText+(inputObj.symptoms!==""?", ":"")+inputObj.symptomsText}
return botui.message.bot({delay:500,loading:!0,content:"এছাড়া, নিচের সমস্যা গুলোর কোনটি কি আপনি ভোগ করছেন?"})}).then(()=>{return botui.action.button({delay:100,multiselect:!0,cssClass:"multiselect",action:[{text:"Moderate to Severe Cough",value:"0",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}},{text:"Feeling Breathless",value:"1",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}},{text:"Difficulty in Breathing",value:"3",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}},{text:"Drowsiness",value:"4",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}},{text:"Persistant Pain and Pressure in Chest",value:"5",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}},{text:"Severe Weakness",value:"6",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}}]})}).then(res=>{inputObj.additionalSymptoms=res.value.join("|");inputObj.additionalSymptomsText=res.text;if(inputObj.temperature==="2"){inputObj.additionalSymptoms=inputObj.temperature+(inputObj.additionalSymptoms!==""?"|":"")+inputObj.additionalSymptoms;inputObj.additionalSymptomsText=inputObj.temperatureText+(inputObj.additionalSymptoms!==""?", ":"")+inputObj.additionalSymptomsText}
return botui.message.bot({delay:500,loading:!0,content:"আপনার বিদেশ ভ্রমন সম্পর্কে তথ্য দিন"})}).then(()=>{return botui.action.button({delay:100,action:[{text:"No Travel History",value:"0"},{text:"No contact with anyone with Symptoms",value:"1"},{text:"History of travel or meeting in affected geographical area in last 14 days",value:"2"},{text:"Close Contact with confirmed COVID in last 14 days",value:"3"}]})}).then(res=>{inputObj.exposureHistory=res.value;inputObj.exposureHistoryText=res.text;return botui.message.bot({delay:500,loading:!0,content:"নীচে প্রদত্ত রোগগোলর মধ্যে কোনটি কি আপনার আছে"})}).then(()=>{return botui.action.button({delay:100,multiselect:!0,cssClass:"multiselect",action:[{text:"Diabetes",value:"0",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}},{text:"High Blood Pressure",value:"1",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}},{text:" Heart Disease",value:"2",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}},{text:"Kidney Disease",value:"3",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}},{text:"Lung disease",value:"4",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}},{text:"Stroke",value:"6",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}},{text:"Reduced Immunity",value:"7",actionStop:!0,event:function(event,button){event.currentTarget.classList.toggle("active")}}]})}).then(res=>{inputObj.underlyingConditions=res.value.join("|");inputObj.underlyingConditionsText=res.text;if(inputObj.symptoms===""&&inputObj.additionalSymptoms==="")
return;return botui.message.bot({delay:500,loading:!0,content:"আপনার যে উপসর্গগুলো আছে গত ৪৮ ঘনটাই তার অবস্থা কি?"})}).then(()=>{if(inputObj.symptoms===""&&inputObj.additionalSymptoms==="")
